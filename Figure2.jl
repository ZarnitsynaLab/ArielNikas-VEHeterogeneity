...
function namedfile1(df,namefile)
    ...
    work_dir="ExampleFigure2-" #Note: This file will save to your working directory unless this line is changed
...
function giveHazards(N, αβ, ββ)
    proto=R" rgamma(n=100000, shape=2, rate=800)" #gamma distribution: not currently in use
    Risk=proto[1:N]
...
Threads.@threads for g in 1:sim_number
    ...
    γ = 5.0          #Recovery time
    r= 0.0025        #Constant Rate of Infection
    attempt1=giveHazards(N,2, 2) #CHANGE HERE: this changes the beta distribution
