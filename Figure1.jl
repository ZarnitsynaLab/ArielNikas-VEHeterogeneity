##--This Julia File Can Be Used to Generate the Files for All Panels in Figure 2. 
...
function namedfile1(df,namefile)
    ...
    work_dir="ExampleFigure1-" #Note: This file will save to your working directory unless this line is changed
...
function giveHazards(N, αβ, ββ)
    proto=R" rgamma(n=100000, shape=0.2, rate=80)" #CHANGE HERE: this provides the gamma distribution
    Risk=proto[1:N]
...
Threads.@threads for g in 1:sim_number
    ...
    attempt1=giveHazards(N,0.2, 0.2) #Beta distrubition available but unused
        ...
        for j in 1:N
            ...
            elseif infected[j]==0 && recovered[j]==0 
                ...
                elseif vaccinated[j]==1#Infect Vaccinated
                    ...
                    if acquire[j]<attempt1[1][j]*0.5 #Vaccination reduces chance to get infected by 50%
                        infected[j]=1
                        infected_time[j]=i
                        ever_infected[j]=1
                        vac_inf= vac_inf+1
